                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h2 class="h2-heading">NgeeekAdmin Automation Will Bring More Quality services</h2>
                        </div> <!-- end of col -->
                    </div> <!-- end of row -->
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>It's very easy to start creating email lists for your web actions. Just create your NgeeekAdmin account</p>
                                </div>
                            </div>
                            <!-- end of card -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Campaigns is a feature we've developed since the beginning because it's at the core of NgeeekAdmin functionalities</p>
                                </div>
                            </div>
                            <!-- end of card -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>NgeeekAdmin collects customer data in order to help you analyse different situations and take required action</p>
                                </div>
                            </div>
                            <!-- end of card -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h2 class="h2-heading">Web service Automation</h2>
                            ...
                            <div class="tab-content" id="argoTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/image.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                <h3>Building a Website Is Easier Than Ever</h3>
                                                <p>It's very easy to start using NgeeekAdmin app. You just need to fill out and submit the <a class="blue page-scroll" href="sign-up.html">Sign Up Form</a> and you will receive access to the app and all of its features in no more than 24h.</p>
                                ...
                                <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/unsplash_4.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                <h3>Performance Monitoring Tools</h3>
                                                <p>Performance monitoring is a feature we've developed since the beginning because it's at the core of NgeeekAdmin and basically to any marketing activity focused on results.</p>
                                                <ul class="list-unstyled li-space-lg">
                                                    <li class="media">
                                                        <i class="fas fa-square"></i>
                                                        <div class="media-body">Easily plan performance checkup and schedule their starting date</div>
                                                    </li>
                                                    <li class="media">
                                                        <i class="fas fa-square"></i>
                                                        <div class="media-body">Start your plan and follow their evolution closely</div>
                                                    </li>
                                                    <li class="media">
                                                        <i class="fas fa-square"></i>
                                                        <div class="media-body">Evaluate your performance results and optimize future actions</div>
                                                    </li>
                                                </ul>
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/unsplash_3.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
            ...
            <div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="image-container">
                                <img class="img-fluid" src="images/unsplash_2.jpg" alt="alternative">
                            </div> <!-- end of image-container -->
                        </div> <!-- end of col -->
                        <div class="col-lg-4">
                            <h3>List Building</h3>
                            <hr>
                            <h5>Core service</h5>
                            <p>It's very easy to start using NgeeekAdmin. You just need to fill out and submit the Sign Up Form and you will receive access to the app.</p>
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                            ...
                            <a class="btn-solid-reg mfp-close" href="{{ route('register') }}">{{ __('SIGN UP') }}</a> <a class="btn-outline-reg mfp-close as-button" href="#screenshots">BACK</a>
                        </div> <!-- end of col -->
                    </div> <!-- end of row -->
                </div> <!-- end of container -->
            ...
            <div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="image-container">
                                <img class="img-fluid" src="images/unsplash_1.jpg" alt="alternative">
                            </div> <!-- end of image-container -->
                        </div> <!-- end of col -->
                        <div class="col-lg-4">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="p-heading">What better way to show off Ngeeek web automation saas app than presenting you some great situations of each module and tool available to users in a video</div>        
                        </div> <!-- end of col -->
                    </div> <!-- end of row -->
                </div> <!-- end of container -->
            </div> <!-- end of basic-2 -->
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="text-wrapper">
                                                <div class="testimonial-text">I started to use NgeeekAdmin with the free trial about a year ago and never stopped since then. It does all the repeating marketing tasks and allows me to focus on core development activities like new product research and design. I love it and recommend it to everyone.</div>
                                                <div class="testimonial-author">Gideon - Online Marketer</div>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="text-wrapper">
                                                ...
                                                <div class="testimonial-author">Isah Jetz - Developer</div>
                                            </div> <!-- end of text-wrapper -->
                                        </div> <!-- end of swiper-slide -->
                                        <!-- end of slide -->
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="text-wrapper">
                                                <div class="testimonial-text">Ngeeek is the best web automation app for small and medium sized business. It understands the mindset of young entrepreneurs and provides the necessary data for wise marketing decisions. Just give it a try and you will definitely not regret spending your time.</div>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="text-wrapper">
                                                <div class="testimonial-text">Ngeeek is one of the greatest web automation apps out there. I especially love the Reporting Tools module because it gives me such a great amount of information based on little amounts of input gathered in just few weeks of light weight usage. Recommended!</div>
                                                <div class="testimonial-author">Hafsat Ismail - Online Marketer</div>
                                            </div> <!-- end of text-wrapper -->
                                        </div> <!-- end of swiper-slide -->
                                        <!-- end of slide -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-container">
                                ...
                                <h2>Stay Updated With The Latest News To Get More website designs</h2>
                                ...
                                <form id="newsletterForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group checkbox">
                                        <input type="checkbox" id="nterms" value="Agreed-to-Terms" required>I've read and agree to Ngeeek's written <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
